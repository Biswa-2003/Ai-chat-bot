...
const NodeHeader = ({ icon: Icon, label, color = "text-gray-700" }) => (
...
// 1. User Query Node
export const UserQueryNode = memo(({ data, isConnectable }) => {
    return (
        <div className="custom-node w-80 node-label-user">
            ...
            <div className="custom-node-body">
                ...
                <textarea
                    ...
                    onChange={(evt) => data.query = evt.target.value}
                />
            </div>
...
// 3. LLM Node
export const LLMNode = memo(({ data, isConnectable }) => {
    return (
        <div className="custom-node w-80 node-label-llm">
            ...
            <div className="custom-node-body">
                ...
                <select
                    ...
                    onChange={(e) => { if (!data.config) data.config = {}; data.config.model = e.target.value; }}
                >
                ...
                <textarea
                    ...
                    onChange={(evt) => { if (!data.config) data.config = {}; data.config.prompt = evt.target.value; }}
                />
